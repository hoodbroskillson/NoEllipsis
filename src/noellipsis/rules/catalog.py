...
HELP_URI = "https://github.com/hoodbroskillson/NoEllipsis/blob/main/README.md#rules"
DOCS_URI = "https://github.com/hoodbroskillson/NoEllipsis/blob/main/docs/sarif.md"
